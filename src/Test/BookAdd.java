...
//
	...
	public BookAdd() {
		...
		contentPane.setLayout(null);
		 ...
		 internalFrame = new JInternalFrame("\u589E\u52A0\u56FE\u4E66\u4FE1\u606F",true,true,true);
		internalFrame.setBounds(10, 0, 751, 551);
		...
		JButton button = new JButton("\u6D4F\u89C8");  //浏览
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					...
					String sql_insert="insert into book_infomation_table (bookname,press,author,isbn,price,bookcount,pressdate) values (?,?,?,?,?,?,?)";
					...
					PreparedStatement sm=con.prepareStatement(sql_insert);
					sm.setString(1,textField_36.getText());
					sm.setString(2, textField_39.getText());
					//sm.setInt(2, Integer.parseInt( textField_35.getText()));							//(2, textField_35.getText());怎样读取文本框里的数字
					sm.setString(3, textField_40.getText());
					sm.setInt(4, Integer.parseInt( textField_35.getText()));
					sm.setInt(5, Integer.parseInt( textField_41.getText()));
					sm.setInt(6, Integer.parseInt( textField_43.getText()));
					sm.setInt(7, Integer.parseInt( textField_42.getText()));			
					/*
					sm.setInt(4,Integer.getInteger(textField_35.getText()));
					sm.setInt(5,Integer.getInteger(textField_41.getText()));
					sm.setInt(6,Integer.getInteger(textField_43.getText()));
					sm.setInt(7,Integer.getInteger(textField_42.getText()));
					*/
		...
		button_1.setBounds(254, 36, 93, 23);
		...
		button_2.setBounds(377, 36, 93, 23);
		panel_2.add(button_2);
		
		label_9 = new JLabel("\u6DFB\u52A0\u6210\u529F");
		label_9.setBounds(22, 10, 54, 15);
		panel_2.add(label_9);
		label_9.setVisible(false);
		
		label_10 = new JLabel("\u6DFB\u52A0 \u5931\u8D25");
		label_10.setBounds(105, 10, 54, 15);
		...
		button_3.setBounds(492, 36, 93, 23);
