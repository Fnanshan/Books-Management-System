...
public class BookModify extends JFrame {
	...
	public BookModify() {
		...
		button_xiugai = new JButton("\u4FEE\u6539");     //修改
		button_xiugai.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					...
					PreparedStatement sm_update=con.prepareStatement(sql_update_book);		//修改书籍信息
		...
		JButton button_1 = new JButton("\u5220\u9664");    //删除
		...
		JButton button_2 = new JButton("\u53D6\u6D88");    //取消
		...
		JRadioButton RadioButton_ISBN = new JRadioButton("ISBN");		//选择按钮：“ISBN”
		...
		JRadioButton RadioButton_book = new JRadioButton("\u4E66\u540D");//选择按钮：“书名”
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					...
					Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance();//加载驱动
					Connection con=DriverManager.getConnection(url, "sa", "1234");//创建连接
					PreparedStatement sm1=con.prepareStatement(sql_select_bookname);		//根据书籍名称查找书籍
					sm1.setString(1,textField_27.getText());
					ResultSet rs1=sm1.executeQuery();
					if(rs1.next()){
						label_11.setVisible(true);//显示“查找成功”
						label_10.setVisible(false);//不显示“查找失败”
						textField_17.setText(rs1.getString(6));							//在上方显示一行图书信息
						...
						label_10.setVisible(true);//显示“查找失败”
						label_11.setVisible(false);//不显示“查找成功”
						textField_17.setText("");	//清空文本框里的内容
					...
					//PreparedStatement sm2=con.prepareStatement(sql_select_isbn);			//根据ISBN称查找书籍
		...
		panel_3.add(button_4);
		 ...
		 label_10 = new JLabel("\u67E5\u627E\u5931\u8D25");//查找失败
		label_10.setBounds(412, 42, 54, 15);
		panel_3.add(label_10);
		
		label_11 = new JLabel("\u67E5\u627E\u6210\u529F");//查找成功过
